...
// Time is a wrapper for gtime.Time for additional features.
type Time struct {
	wrapper
}

// apiUnixNano is an interface definition commonly for custom gtime.Time wrapper.
type apiUnixNano interface {
	UnixNano() int64
}

// New creates and returns a Time object with given parameter.
// The optional parameter can be type of: gtime.Time/*gtime.Time, string or integer.
...
// NewFromTime creates and returns a Time object with given gtime.Time object.
